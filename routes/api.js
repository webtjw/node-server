...
const {saveArticle, queryTagsAndCategories} = require('../modules/article');
...
.get('/articled/detail/:id', async (ctx, next) => {
...
apiRouter.post('/article/tagsAndCategory', queryTagsAndCategories);
