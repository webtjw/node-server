...
.comment-container {
  .comment-input .comment-value {
    width: 100%; border-radius: 3px; border: 1px solid #aaa; outline: none; line-height: 24px; height: 44px; transition: all .4s ease-out; box-shadow: 0 0 8px 2px #ddd; overflow-y: auto;
